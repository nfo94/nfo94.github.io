...
![anatomia de um processo](./concorrencia-e-paralelismo-em-python-imgs/composição-de-um-processo.png)
...
![diagrama de concorrência em Python](./concorrencia-e-paralelismo-em-python/'diagrama de concorrencia.png')
